<template>
  	<div class="registerwrap">
  		<div class="header">
			<div class="lefthead">
				<img src="../../assets/logo-slogan_443548c6.png" class="headerlogo">
			</div>
			<div class="righthead">
				<a href="#" class="show">
				<i class="fa fa-mobile fa-lg"></i> 拉勾APP
				<span class="shuxian">|</span>
				<img class="qrcode_app" src="//www.lgstatic.com/lg-landingpage-fed/pc/images/qrcode-new_69efb8b8.png">
				</a>
				<a @click="goto">
				   去登录 >  
				</a>
		...
		<div class="middle">
			...
			<div class="rightmiddle">
				...
				<form class="form-right">
					...
					<p class="xieyi">注册代表你已同意<a href="#">「拉勾用户协议」</a></p>
				</form>
...
>>>>>>> 5fe315124b2090c9111bede61cccafd41bf133b3
